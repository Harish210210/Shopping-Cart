	      		...
	      		success:function(res){
		      		 res.map((ele)=>{
				    	...
				    	+ele.image+'" /></td><td>&nbsp;</td><td><div class="p-3"><h2>'
				      	+ele.pname+'</h2><h4>'
				     	+ele.price+'/-</h4></div></td><td><div class="p-3"><ul><li>7 Days Service Center Replacement</li><li>Free Delivery</li><li>Cash on Delivery Available</li><li>10% discount on Axis Bank Credit Card</li><li>1 Year Warranty</li></ul></div></td><td><input type="number" id="cnt'
				     	+ele.pid+'" value=1 min=1 max=10 class= "m-2 input form-control" /><button data-bs-toggle="modal" data-bs-target="#addcart" onclick="adc('
				     	+ele.pid+')" class="m-2 form-control bg-info">Add to Cart</button></td></tr>';
				      	$("#ptable").append(row);
		      		 })
	      		}
	      	})
