...
public class CheckoutList {
	public HashMap<String, ArrayList<String>> getCheckoutList() {
		...
		try {
			...
			ResultSet rs = st.executeQuery(
					"SELECT h_products.pid, h_products.price, h_cart.quantity, h_products.pname, h_hsncode.gst FROM h_products JOIN h_cart ON h_products.pid = h_cart.pid JOIN h_hsncode ON h_products.hsn_code = h_hsncode.hsn_code");
