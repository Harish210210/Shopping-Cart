...
public class GetCategoryList {
	public HashMap<String, ArrayList<String>> getList(String catname) {
		...
		try {
			...
			ResultSet rs = st.executeQuery(
					"SELECT * FROM h_products JOIN h_pcategory ON h_products.pcatid = h_pcategory.pcatid WHERE h_pcategory.pcatname = '"
							+ catname + "';");
